...
5. **Cloudflare deploy path** — documented, one-command, with Prisma Postgres + Accelerate setup guide (staging + production).
...
- [ ] **T-034** Prisma Postgres + Accelerate setup guide + migration workflow for Cloudflare CI
