...
export const ALPHA_RESEARCH_PLAYBOOK: AlphaPlaybookStep[] = [
  ...
  },
  {
    step: 2,
    method: "GET",
    path: "/api/alphas/tapes",
    purpose: "List stored harvest/import tapes; hasEvent=1 keeps markets with event extras",
  },
  {
    step: 3,
    method: "POST",
    path: "/api/alphas/research",
    purpose: "One-shot scan + sweep (+ optional OOS split); returns promote payloads",
  },
  {
    step: 4,
    method: "GET",
